<h1> Customizing Coffee Orders</h1>
...
<h3> Interface Consistency: All components (basic coffee and additions) should share a common interface so that additions can wrap other additions or the base coffee. </h3>
